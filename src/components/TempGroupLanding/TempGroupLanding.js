...
import "./TempGroupLanding.scss";

import GroupForm from "../Forms/GroupForm/GroupForm";

const TempGroupLanding = React.forwardRef((props, ref) => {
  return (
    <div className={classnames("TempGroupLanding", props.className)}>
        <div className="groupContainer">
            <h4 className="groupTittle">You aren't in a group yet!</h4>
            <p className="cardText">Please join or create a group</p>
            <div>
                <a>
                    Join Group
                </a>
...
TempGroupLanding.propTypes = {
  className: PropTypes.string
};

TempGroupLanding.defaultProps = {};

export default TempGroupLanding;
